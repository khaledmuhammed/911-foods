...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <div class="form-group row ">
        ...
        {{-- <div class="form-text text-muted">
          Valid Earnings for this market: {{App\Models\Earning::where('market_id',$market['id'])->first()['vaild_earning']}}
        </div> --}}
    </div>
</div>
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <div class="form-group row ">
        ...
        <div class="col-9">
            {!! Form::textarea('note', null, ['class' => 'form-control', 'placeholder' => trans('lang.markets_payout_note_placeholder')]) !!}
...
<div class="form-group col-12 text-right">
    <button type="submit" class="btn btn-{{ setting('theme_color') }}"><i class="fa fa-save"></i>
        {{ trans('lang.save') }} {{ trans('lang.markets_payout') }}</button>
