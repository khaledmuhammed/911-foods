                ...
                <div class="container w-full flex flex-col pt-4 ">
                    ...
                    <div class="flex items-center justify-between">
                        <h2 class="text-black font-bold text-4xl pt-3 pb-2">
                            {{__("Top Rated Products")}}
                        </h2>
                        <a id="foods" href="#foods" class="btn custom-btn-blue bg-green rounded-3xl py-2 px-4 leading-6">
                            {{__("Total")}} {{$total}}
                        </a>
                    </div>
                    ...
                    <ul class="pagination justify-content-center">
                        ...
                        <li class="page-item ">
                            <p class="page-link cursor-default text-black hover:text-gray-600 hover:bg-transparent ">
                                {{__("Page")}} {{$products->currentPage()}}  {{__("of")}} {{$products->lastPage()}}
                            </p>
                        </li>
