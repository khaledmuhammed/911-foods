...
@section('content')
    ...
    <main class="w-full mt-16 mb-2 flex flex-row justify-center" >
        <div class="container w-4/5 md:w-3/5 lg:w-1/3 mt-3 shadow-2xl p-3  bg-white" style="height:fit-content;" >
            <ul class="nav nav-pills w-full flex flex-row justify-between" id="myTabn" >
                <li class="nav-item flex-1" role="presentation">
                    <a class="nav-link custom-btn text-center mr-2 hover:bg-gray-100 " id="login-tab"  href="/login" role="tab" aria-controls="login" aria-selected="true">
                        {{ __('Login')}} 
                    </a>
                </li>
                <li class="nav-item flex-1" role="presentation">
                    <a class="nav-link custom-btn active text-center ml-2 hover:bg-gray-100" id="sign-tab"  href="/register" role="tab" aria-controls="register" aria-selected="false">
                        {{ __('Sign in')}} 
                    </a>
                </li>
            </ul>
